...
const CATEGORIES = [
  {
    ...
    games: [
      { name: "Skull King",                 price: "₡4.000", players: "2-6 jugadores", time: "20-30 min", type: "Cartas",     image: "/images/skullking.webp" },
      ...
      { name: "Chameleon",                  price: "₡4.000", players: "3-8 jugadores", time: "15 min",    type: "Deducción",  image: "/images/chameleon.webp" },
      { name: "Fantasma Blitz",             price: "₡4.000", players: "2-8 jugadores", time: "5 min",     type: "Velocidad",  image: "/images/fantasmablitz.webp" },
      { name: "Cockroach Poker",            price: "₡3.000", players: "2-6 jugadores", time: "20 min",    type: "Bluff",      image: "/images/pokerdebichos.webp" },
      { name: "Joking Hazard",              price: "₡4.000", players: "3-10 jugadores",time: "30 min",    type: "Party",      image: "/images/jokinghazzard.webp" },
      { name: "Trial by Trolley",           price: "₡4.000", players: "4-13 jugadores",time: "30 min",    type: "Party",      image: "/images/trialbytrolley.webp" },
      { name: "Fast Food Fear",             price: "₡4.000", players: "2-6 jugadores", time: "20 min",    type: "Party",      image: "/images/fastfoodfear.webp" },
      { name: "Chao Pescao",               price: "₡4.000", players: "3-7 jugadores", time: "15 min",    type: "Party",      image: "/images/chaopescao.webp" },
      { name: "Hues and Cues",              price: "₡5.000", players: "3-10 jugadores",time: "30 min",    type: "Party",      image: "/images/huesandcues.webp" },
      { name: "The Mind",                   price: "₡3.000", players: "2-4 jugadores", time: "15 min",    type: "Cooperativo",image: "/images/themind.webp" },
      { name: "Sushi Go",                   price: "₡4.000", players: "2-5 jugadores", time: "15 min",    type: "Cartas",     image: "/images/sushigo.webp" },
    ],
  },
  {
    title: "Para Parejas",
    ...
    games: [
      ...
      { name: "Raptors",        price: "₡5.000", players: "2 jugadores",   time: "30 min",    type: "Estrategia",  image: "/images/raptors.webp" },
      { name: "House of Danger",price: "₡5.000", players: "1-6 jugadores", time: "60 min",    type: "Aventura",    image: "/images/houseofdanger.webp" },
    ],
  },
  {
    title: "Estrategia",
    ...
    games: [
      ...
      { name: "Pandemic",       price: "₡6.000", players: "2-4 jugadores", time: "45-60 min",  type: "Cooperativo", image: "/images/pandemic.webp" },
      { name: "King of Tokyo",  price: "₡5.000", players: "2-6 jugadores", time: "30 min",     type: "Dados",       image: "/images/kingoftokyo.webp" },
      { name: "King of New York",price:"₡6.000", players: "2-6 jugadores", time: "40 min",     type: "Dados",       image: "/images/kingofnewyork.webp" },
      { name: "Kaiju Crush",    price: "₡5.000", players: "2-4 jugadores", time: "30-45 min",  type: "Área",        image: "/images/kaijucrush.webp" },
      { name: "The Island",     price: "₡5.000", players: "2-4 jugadores", time: "60 min",     type: "Estrategia",  image: "/images/theisland.webp" },
      { name: "Here to Slay",   price: "₡5.000", players: "2-6 jugadores", time: "30-60 min",  type: "Cartas",      image: "/images/heretoslay.webp" },
      { name: "Food Truck Race",price: "₡6.000", players: "2-4 jugadores", time: "45-60 min",  type: "Estrategia",  image: "/images/foodtruckrace.webp" },
      { name: "Sauros",         price: "₡6.000", players: "2-4 jugadores", time: "45 min",     type: "Estrategia",  image: "/images/sauros.webp" },
    ],
  },
];
